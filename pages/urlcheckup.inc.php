		...
		<tr>
			...
			<td class="td3">
                ...
                <div class="input-group sbeg">
                    <input class="form-control" type="text" name="s_sbeg" id="s_sbeg" maxlength="50" value="<?php echo aFM_maskChar($_SESSION['as_sbeg_urllist']); ?>" placeholder="Suchbegriff">
                    <span class="input-group-btn">
                        <a class="btn btn-popup form-control-btn" title="Suche zurücksetzen ..." id="s_resetsbeg"><i class="rex-icon fa-close"></i></a>
                    </span>
                </div>
                <input name="submit" type="button" value="<?php echo $this->i18n('a1544_search_submit'); ?>" class="button" id="s_button" style="display:none" />
